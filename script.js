...
function criptografar(stringEncriptada) {
    let matrizCodigo = [["e", "enter"], ["i", "imes"], ["a", "ai"], ["o", "ober"], ["u", "ufat"]]; // usando Array
    ...
    for(let i = 0; i < matrizCodigo.length; i++) { // for(let i=0; - Usada para criar a variável de controle de loop
...
function descriptografar(stringDesencriptada) {
    let matrizCodigo = [["e", "enter"], ["i", "imes"], ["a", "ai"], ["o", "ober"], ["u", "ufat"]]; // let - usado para indicar uma variavel onde poderá haver mudanças.
...
function copiarTexto() { // Funçãi utilizada para copiar o texto dentro de um navegador web.
    navigator.clipboard.writeText(mensagem.value).then(() => { // linha utilizada em copiar para área de trsnferencia.
